...
const CoverPage = () => {
  ...
  const fetchImages = async () => {
    ...
    try {
      const coverRes = await fetch(
        "https://bcknd.sea-go.org/village/cover_village",
        {
          headers: {
      ...
      const profileRes = await fetch(
        "https://bcknd.sea-go.org/village/profile_image_village",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const handleImageUpload = async () => {
    ...
    try {
      const response = await fetch(
        "https://bcknd.sea-go.org/village/cover_village/add",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleDeleteImage = async () => {
    ...
    try {
      const response = await fetch(
        "https://bcknd.sea-go.org/village/cover_village/delete",
        {
          method: "DELETE",
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleUpdateProfileImage = async () => {
    ...
    try {
      const response = await fetch(
        "https://bcknd.sea-go.org/village/profile_image_village/add",
        {
          method: "POST",
          headers: {
            Authorization: `Bearer ${token}`,
